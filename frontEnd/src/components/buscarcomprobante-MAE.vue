...
export default {
    ...
    methods:{
      ...
      MostrarDetalles(dat){
        ...
        axios.post(link.url,{
              ...
              .then(response => {
                    if (response.data.length <1){
                      ...
                      variablesEntorno.listCli=response.data;
                      Object.keys(variablesEntorno.listCli).map( d => {});
                      if (variablesEntorno.listCli[0].email != null && variablesEntorno.listCli[0].email != '') {variablesEntorno.detallesEmail = variablesEntorno.listCli[0].email}; //variablesEntorno.detallesEmail = variablesEntorno.listCli[0].email; para ecommerce
                      //variablesEntorno.detallesPrefijo = variablesEntorno.listCli[0].telephonePrefix; //ESTE ES DE BASE ECOMMERCE DE CLIENTES
                      variablesEntorno.detallesTelefono = variablesEntorno.listCli[0].telephone;
                      variablesEntorno.detallesInterno = variablesEntorno.listCli[0].telephoneIntern;
                    }
        ...
        variablesEntorno.detallesRazonSocial= dat.businessName;
        variablesEntorno.detallesNroComprobante = dat.receiptNumber;
        variablesEntorno.detallesFechaRealizado = dat.dateDone;
        variablesEntorno.detallesCUIT= dat.cuit;
        variablesEntorno.detallesIdCliente= dat.customerId;
        //variablesEntorno.detallesCondImpositiva= DevolverTexto(dat.taxConditionId)[0]; //ECOMMERCE
        variablesEntorno.detallesCondImpositiva = dat.customerTax.taxCondition.description;
